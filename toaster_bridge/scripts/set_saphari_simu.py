...
if __name__=="__main__":
  ...
  set_pose_client("GREY_TAPE","object",-0.8,11.7,0.72,0.0,0.0,0.0)
  set_pose_client("LOTR_TAPE","object",0.3,11.7,0.72,0,0,0)
  set_pose_client("WALLE_TAPE","object",-0.2,11.7,0.72,0,0,0)
  ...
  set_pose_client("PR2_ROBOT","robot",-0.8,13.9,0,0,0,2.9)
  set_pdg()
